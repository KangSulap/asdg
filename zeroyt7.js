...
creator = 'Zero YT7' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = 'DpinV2' // UBAH NAMA LU
...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6285694982557@s.whatsapp.net`]
...
but = [
        ...
        sendButImage(from, teks, "©DpinV2", gam, but)
break
...
costum(buffer, sticker, Verived, `DpinV2`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
reply('TUHH ANJNC NOMOR OWNER GW YANG PALING GANTENG')
break
case 'bc':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(`6285694982557@s.whatsapp.net`, options, text, { quoted: ftrol })
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Tuh bang'})
break
case 'tiktok':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih bang'})
break
case 'tiktokmusic':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih bang'})
break
//━━━━━━━━━━━━━━━[ FITUR ANIME ]━━━━━━━━━━━━━━━━━//
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih bang'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih bang'})
break
case 'asupancecan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih bang'})
break
case 'asupanhijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih bang'})
break
case 'cecanmalaysia':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
sendButton(from, "GOPAY : 085594982557 (Devin)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 085694982557 (Devin)", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 085694982557 (Devin)", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : 085694982557
❍┤ヅ Dana : 085694982557
❍┤ヅ Ovo : 085694982557
❍┤ヅ Pulsa : 085694982557
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
